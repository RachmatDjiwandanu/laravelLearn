        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 col-xl-6 text-center">
                    ...
                    <hr class="divider" />
                    <p class="text-muted mb-5">Ada kendala/masalah? Kirimi kami pesan dan kami akan menghubungi Anda sesegera
                        mungkin!</p>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="/contact" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <textarea name="message" id="message" class="form-control" type="text" placeholder="Enter your message here..."
